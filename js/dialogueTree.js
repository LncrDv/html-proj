// =============================================================
// DIALOGUE TREE — Full story, Days 1–7, SFW + NSFW
//
// All fields that branch on nsfwMode are arrow functions () => ...
...
// =========================================================
    ...
    day2_food_choice: {
        ...
        ghostChoice: { label: "Chinese", next: "day2_branch_ghost_glitch_chinese" },
        next: null
    },
...
// =========================================================
    ...
    day7_nsfw_phase2: {
        ...
        choices: [
            { label: "I don't know what you mean.", next: "day7_nsfw_deny"   },
    ...
    day7_nsfw_phase3: {
        ...
        choices: [
            { label: "That's not true.", next: "day7_nsfw_resist"  },
